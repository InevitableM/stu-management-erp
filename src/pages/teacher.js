...
const toggleNotices = () => {
  ...
  return (
    <div className="teacher-page">
       <div className="navbar">EduSpark ERP
        <FaBell className="notice-icon" onClick={toggleNotices}/>
       </div>
       <h1> Course: {course}</h1>
       {
        showNotices && (
    ...
    <section>
      <form onSubmit={scheduleExam}>
       <h1>schedule Exam</h1>
        <input type="text" placeholder="Course" onChange={(e)=>setExam({...exam,course:e.target.value})}/>
        <input type="date" placeholder="Date" onChange={(e)=>setExam({...exam,date:e.target.value})}/>
